#
#  Be sure to run `pod spec lint SampleStaticLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "fojas10" => "email@address.com" }
  # Or just: s.author    = "fojas10"
  # s.authors            = { "fojas10" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/fojas10"
